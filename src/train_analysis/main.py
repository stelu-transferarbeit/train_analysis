...
datasets = {
    "rail_length": "https://ec.europa.eu/eurostat/api/dissemination/sdmx/3.0/data/dataflow/ESTAT/rail_if_line_na/1.0/*.*.*.*.*?c[freq]=A&c[unit]=KM&c[tra_infr]=TOTAL,RL_ELC&c[tra_meas]=FR_ONL,TOTAL&compress=true&format=csvdata&formatVersion=1.0&lang=en&labels=label_only",
    ...
    "rail_passengers": "https://ec.europa.eu/eurostat/api/dissemination/sdmx/3.0/data/dataflow/ESTAT/rail_pa_total/1.0?compress=true&format=csvdata&formatVersion=1.0&lang=en&labels=label_only&c[freq]=A&c[unit]=MIO_PKM",
    ...
    "modal_split": "https://ec.europa.eu/eurostat/api/dissemination/sdmx/3.0/data/dataflow/ESTAT/tran_hv_ms_psmod/1.0?compress=true&format=csvdata&formatVersion=1.0&lang=en&labels=label_only",
    # "rail_investment": "https://sdmx.oecd.org/public/rest/data/OECD.ITF,DSD_INFRINV@DF_INFRINV,1.0/.A..EUR.TOT_INL+MAR+AIR.Q",
    "rail_accidents": "https://ec.europa.eu/eurostat/api/dissemination/sdmx/3.0/data/dataflow/ESTAT/rail_ac_catnmbr/1.0/*.*.*.*?c[freq]=A&c[unit]=NR&c[accident]=TOTAL&c[geo]=EU27_2020,EU28,EU27_2007,BE,BG,CZ,DK,DE,EE,IE,EL,ES,FR,HR,IT,CY,LV,LT,LU,HU,MT,NL,AT,PL,PT,RO,SI,SK,FI,SE,LI,NO,CH,UK,ME,MK,TR&compress=true&format=csvdata&formatVersion=2.0&lang=en&labels=name",
}
...
def transform_rail_length(data: pd.DataFrame):
    ...
    pass_data["OBS_VALUE"] -= pass_data["OBS_VALUE_freight"]
    print(pass_data)
    return pass_data.loc[
        :,
